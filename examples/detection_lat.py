\
"""
Launcher for Hip Joint Detection — LAT View (Faster R-CNN).
...
def main():
    ...
    parser.add_argument("--view", type=str, default="LAT", choices=["AP","LAT"], help="View to use")
    parser.add_argument(
        "--fold",
        type=str,
        default="1",
    ...
    parser.add_argument("--name", type=str, default="detection_lat")
